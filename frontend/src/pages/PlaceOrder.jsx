    ...
    <div className="mt-8">
      ...
      ${method === "cod"
        ...
        <div className="w-full text-end mt-8">
          <button onClick={() => navigate('/orders')} className="bg-black text-white px-10 sm:px-16 py-3 rounded-lg text-sm font-semibold tracking-wide shadow-md hover:bg-gray-900 hover:shadow-xl active:scale-95 transition-all duration-200 cursor-pointer">
            PLACE ORDER
          </button>
        </div>
      </div>
